# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in show-and-tell.
...
import showandtell
from showandtell import model, lib
...
base_config.package = showandtell
...
base_config.model = showandtell.model
base_config.DBSession = showandtell.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "d21f8440-17a6-4d58-b762-05e4a057ecf1"
